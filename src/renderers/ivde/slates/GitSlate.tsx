...
const Dialog = ({
  ...
  console.log('Dialog render - isOpen:', isOpen(), 'title:', title);
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              border: "1px solid " + (type === "danger" ? "#f85149" : "#2ea043"),
              color: "#ffffff",
              "font-size": "12px",
              padding: "6px 12px",
              "border-radius": "4px",
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = type === "danger" ? "#b91c1c" : "#1f6333";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = type === "danger" ? "#da3633" : "#238636";
            }}
          >
            {confirmText}
          </button>
